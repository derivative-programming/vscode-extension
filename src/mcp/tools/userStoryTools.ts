...
export class UserStoryTools {
     ...
     * @param parameters Tool parameters containing name of the role to add
    ...
    public async add_role(parameters: any): Promise<any> {
        ...
        try {
            const result = await this.postToBridge('/api/roles', { name });
    ...
    private isPascalCase(str: string): boolean {
        ...
        // Examples: Administrator, DataEntryClerk, Manager123
