            ...
            schema: {
                ...
                properties: {
                    ...
                    isExposedInBusinessObject: {
                        ...
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Defines access to business logic functionality. If true, the form workflow is exposed in the business object API.',
                        examples: ['true', 'false']
                    },
                    isObjectDelete: {
                        type: 'string',
                    ...
                    formFooterImageURL: {
                        type: 'string',
                        required: false,
                        description: 'URL of an image to display in the form footer.',
                        examples: ['/images/footer-logo.png', 'https://cdn.example.com/footer.jpg']
                    },
                    codeDescription: {
                        type: 'string',
                        required: false,
                    ...
                    isImpersonationPage: {
                        ...
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Is this an impersonation page? String "true" or "false".',
                        examples: ['true', 'false']
                    },
                    roleRequired: {
                        type: 'string',
                    ...
                    isCreditCardEntryUsed: {
                        ...
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Does this form include credit card entry? String "true" or "false".',
                        examples: ['true', 'false']
                    },
                    headerImageURL: {
                        type: 'string',
                        required: false,
                        description: 'URL of an image to display in the form header.',
                        examples: ['/images/header-logo.png', 'https://cdn.example.com/header.jpg']
                    },
                    footerImageURL: {
                        type: 'string',
                        required: false,
                        description: 'URL of an image to display in the form footer.',
                        examples: ['/images/footer-logo.png']
                    },
                    isDynaFlow: {
                        type: 'string',
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Is this a DynaFlow workflow? String "true" or "false".',
                        examples: ['true', 'false']
                    },
                    isDynaFlowTask: {
                        type: 'string',
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Is this a DynaFlow task? String "true" or "false".',
                        examples: ['true', 'false']
                    },
                    isCustomPageViewUsed: {
                        ...
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Does this form use a custom page view? String "true" or "false".',
                        examples: ['true', 'false']
                    },
                    isIgnoredInDocumentation: {
                        ...
                        required: false,
                        enum: ['true', 'false'],
                        description: 'Should this form be ignored in documentation? String "true" or "false".',
                        examples: ['true', 'false']
                    },
                    targetChildObject: {
                        type: 'string',
