...
exports.ReportParamModel = void 0;
class ReportParamModel {
    ...
    constructor(data) {
        ...
        if (data?.targetColumnName !== undefined) {
    ...
    toJson() {
        ...
        if (this.targetColumnName !== undefined) {
            json.targetColumnName = this.targetColumnName;
        }
...
exports.ReportParamModel = ReportParamModel;
//# sourceMappingURL=reportParamModel.js.map