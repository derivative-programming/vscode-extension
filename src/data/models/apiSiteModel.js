...
class ApiSiteModel {
    ...
    constructor(data) {
        ...
        if (data?.isSiteLoggingEnabled !== undefined) {
            this.isSiteLoggingEnabled = data.isSiteLoggingEnabled;
        }
        if (data?.apiLogReportName !== undefined) {
            this.apiLogReportName = data.apiLogReportName;
        }
        if (data?.apiEnvironment !== undefined) {
    ...
    toJson() {
        ...
        if (this.isSiteLoggingEnabled !== undefined) {
            json.isSiteLoggingEnabled = this.isSiteLoggingEnabled;
        }
        if (this.apiLogReportName !== undefined) {
            json.apiLogReportName = this.apiLogReportName;
        }
...
exports.ApiSiteModel = ApiSiteModel;
//# sourceMappingURL=apiSiteModel.js.map