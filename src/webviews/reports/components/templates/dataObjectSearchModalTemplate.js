 ...
 * Purpose: Provides a modal interface for browsing and selecting target child object names from available data objects
 */
...
<div class="modal-content">
    ...
    <div class="form-row">
        ...
        <div class="field-note">Select a data object from the list to use as the target child object.</div>
    </div>
