...
/**
 * File: addOutputVariableModalTemplate.js
 * Purpose: Provides HTML template for the Add Output Variable modal in forms
 * Created: 2025-08-02
 */

/**
 * Generates the HTML content for the Add Output Variable modal
