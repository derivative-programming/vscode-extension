// src/webviews/modelAIProcessingDetailsView.js
// Handles displaying the details of a specific AI processing request in a webview.
...
(function() {
    ...
    window.addEventListener('message', event => {
        ...
        switch (message.command) {
            case 'modelAIProcessingSetRequestDetails':
                console.log("[Webview] Full details data:", message.data);
                currentRequestData = message.data;
                renderDetails(message.data);
                break;
            case 'modelAIProcessingSetError':
                renderError(message.text);
                break;
            case 'modelAIProcessingReportExistsResult':
                handleReportExistsResult(message);
                break;
            case 'modelAIProcessingReportDownloadStarted':
                updateButtonToProcessing();
                break;
            case 'modelAIProcessingReportDownloadSuccess':
            ...
            case 'reportOpened':
                ...
                break;
            case 'modelAIProcessingReportDownloadError':
    ...
    function updateButtonAfterSuccess() {
        ...
        if (button) {
            ...
            // Update the click handler to use modelAIProcessingViewReport
    ...
    /**
     * Renders the AI processing request details in the container.
    ...
    function renderDetails(data) {
        ...
        console.log("Description value:", data.modelPrepRequestDescription);
        console.log("Requested time value:", data.modelPrepRequestRequestedUTCDateTime);
     ...
     */    function renderError(text) {
      ...
      // Send message to extension that webview is ready    console.log("[Webview] Sending webviewReady");
