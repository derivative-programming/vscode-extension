...
exports.openModelExplorer = openModelExplorer;
 ...
 */
function openModelExplorer(context, modelService, viewType = "objects") {
    ...
    const panel = vscode.window.createWebviewPanel(`modelExplorer${viewType}`, `App DNA ${viewType.charAt(0).toUpperCase() + viewType.slice(1)}`, vscode.ViewColumn.One, {
        enableScripts: true,
 ...
 */
function getWebviewContent(items, viewType) {
...
//# sourceMappingURL=modelExplorerView.js.map