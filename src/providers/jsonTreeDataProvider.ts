    ...
    getChildren(element?: JsonTreeItem): Thenable<JsonTreeItem[]> {
        ...
        if (!element) {
            if (fileExists) {
                ...
                projectItem.tooltip = "Project settings and configuration";                  const dataObjectsItem = new JsonTreeItem(
                    'DATA OBJECTS',
                    vscode.TreeItemCollapsibleState.Collapsed,
                    'dataObjects showHierarchy showDataObjectFilter showDataObjectList showDataObjectUsageAnalysis'
                );
        ...
        if (element?.contextValue?.startsWith('analysis') && fileExists) {
            try {
                ...
                userStoryQAItem.tooltip = "View QA testing forecast and schedule";
                userStoryQAItem.command = {
                    command: 'appdna.userStoriesQA',
                    title: 'Show QA Forecast',
                    arguments: ['forecast']
                };
