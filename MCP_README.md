...
This VS Code extension includes a comprehensive Model Context Protocol (MCP) server that provides **91 tools** for interacting with the AppDNA model.

## Features

### **91 Comprehensive Tools** ✅ Verified with GitHub Copilot
...
9. **list_model_validation_requests** - List validation requests with status and results
10. **create_model_validation_request** - Submit a new validation request with current model file
11. **get_model_validation_request_details** - Get detailed information for a specific validation request by request code
12. **get_model_validation_request_schema** - Get JSON schema definition for validation request objects
13. **list_fabrication_blueprint_catalog_items** - List available fabrication blueprints (template sets) with selection status
14. **select_fabrication_blueprint** - Add a fabrication blueprint from the catalog to your AppDNA model (requires name AND version)
15. **unselect_fabrication_blueprint** - Remove a fabrication blueprint from your AppDNA model (requires name AND version)
16. **list_model_fabrication_requests** - List fabrication requests with status and download information
17. **create_model_fabrication_request** - Submit a new fabrication request with current model file
18. **get_model_fabrication_request_details** - Get detailed information for a specific fabrication request by request code
19. **get_model_fabrication_request_schema** - Get JSON schema definition for fabrication request objects
